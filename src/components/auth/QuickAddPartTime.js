            ...
            <View style={styles.container}>
                ...
                <View style={styles.contents}>
                    <FlatList
                        ...
                        renderItem={({ item, index }) => <ListItem index={index} item={item} navigation={this.navigation} />}
    ...
    flatListHeader() {
        return (
            <View style={styles.listHeader}>
                ...
                <Text style={styles.listHeaderText}>빠른 등록</Text>
            </View>
        );
    }
}
    ...
    render() {
        return (
            <TouchableOpacity
                ...
                <Text style={styles.listItemText}>{this.item.name}</Text>
            </TouchableOpacity>
        );
    }
}
