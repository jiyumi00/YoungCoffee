    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <EmployeeHeader navigation={this.props.navigation} changeEmployeeKindListener={(kind)=>this.changeEmployeeKind(kind)} addEmployeeListener={()=>this.addEmployee()}/>
